...
thumbnail: "/assets/images/gen/projects/project-grading-redesign-thumbnail.png"
image: "/assets/images/gen/content/project-grading-redesign/visual-design/grade.png"
comments: false
subscribe: true
client: BuyBay
type: case study
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/old/grading-checkbox.png" title="Old design of a grading step: checkbox question (more than one option possible)" %}

{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/old/grading-radio.png" title="Old design of a grading step: radio button question (only one option possible)" %}
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/visual-design/grade.png" title="Redesign of the grading step with ‘radio button’ answers (only one possible answer)" %}
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/visual-design/popup.png" title="Popup with all information on the current return" %}

{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/visual-design/checkboxes.png" title="Redesign of a grading step with ‘checkbox’ answers; more than one possible answer" %}

{% include framework/shortcodes/figure.html width="40%" src="/assets/images/gen/content/project-grading-redesign/visual-design/grading-mobile.png" title="Redesign of the mobile version" %}
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/icon-not-understood.png" title="These icons were too similar" %}

I eventually redesigned them like this:

{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-grading-redesign/icon-redesign.png" title="Icons redesign" %}

[Read the full test plan and the results.](/assets/images/gen/content/project-grading-redesign/test-plan.pdf)
