...
thumbnail: "/assets/images/gen/projects/project-routing-thumbnail.png"
image: "/assets/images/gen/content/project-routing/visual-design/preview.png"
weight: 1
client: BuyBay
type: case study
---
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-routing/old-rules.png" title="List of counting rules" %}
...
{% include framework/shortcodes/figure.html width="50%" src="/assets/images/gen/content/project-routing/edit-rule.png" title="Form to edit a rule" %}
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-routing/wireframes/owner-preview.jpeg" title="Generated flow chart for an owner" %}
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-routing/wireframes/edit-owner-rule.png" title="Generated flow chart for an owner" %}
...
{% include framework/shortcodes/figure.html width="50%" src="/assets/images/gen/content/project-routing/wireframes/edit-rule-form-top.png" title="Form to edit owner rule" %}

The stakeholders were very happy with this solution, so I continued with a visual design.

[Read the full wireframes](/assets/images/gen/content/project-routing/wireframes/wireframes-v2.pdf)

# Visual design

{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-routing/visual-design/preview.png" title="Generated flow chart for an owner" %}

{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-routing/visual-design/sort-owner-rules.png" title="Visual design of the sorting page" %}
...
{% include framework/shortcodes/figure.html src="/assets/images/gen/content/project-routing/production-rules.png" title="Counting rule flowchart in production" %}
